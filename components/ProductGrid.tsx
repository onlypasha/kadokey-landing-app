...
const products = [
    ...
    },
    {
        ...
        tag: "Limited",
        color: "bg-kadokey-yellow text-kadokey-navy",
    },
    {
        id: 5,
        name: "Aneka Masker",
        price: "Rp. 10.000",
        rating: 4.6,
        image: "/images/produk/aneka-masker.png",
        tag: "Colorfull",
        color: "bg-kadokey-pink",
    },
    {
        id: 6,
        name: "ATK dan keperluan sekolah",
        price: "Rp. 5.000",
        rating: 4.6,
        image: "/images/produk/atk-dan-keperluan-sekolah.png",
        tag: "Office | School",
        color: "bg-kadokey-navy",
    },
    {
        id: 7,
        name: "Tumbler, Tempak makan, Tas, dan Lainnya",
        price: "Rp. 30.000",
        rating: 4.6,
        image: "/images/produk/tumbler-tempatmakan-tas-lainnya.png",
        tag: "Daily",
        color: "bg-kadokey-pink",
    },
    {
        ...
        price: "Rp. 20.000",
        rating: 4.6,
        image: "/images/produk/tumbler.png",
        tag: "Healty",
        color: "bg-kadokey-pink",
    },
];
